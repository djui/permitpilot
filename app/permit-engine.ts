...
export const ui = {
  en: {
    home: "Home", how: "How it works", sources: "Official sources", about: "About", history: "Changes", legal: "Legal", verified: "Last rules review 22 Aug 2026",
  ...
  de: {
    home: "Start", how: "So funktioniert’s", sources: "Offizielle Quellen", about: "Über uns", history: "Änderungen", legal: "Rechtliches", verified: "Letzte Regelprüfung 22. Aug. 2026",
  ...
  fr: {
    home: "Accueil", how: "Fonctionnement", sources: "Sources officielles", about: "À propos", history: "Changements", legal: "Mentions", verified: "Dernière revue des règles le 22 août 2026",
  ...
  it: {
    home: "Inizio", how: "Come funziona", sources: "Fonti ufficiali", about: "Chi siamo", history: "Modifiche", legal: "Note legali", verified: "Ultima verifica delle norme il 22 ago 2026",
  ...
  rm: {
    home: "Cumenzament", how: "Co funcziun’igl", sources: "Funtaunas uffizialas", about: "Davart nus", history: "Midadas", legal: "Legal", verified: "Ultima verificaziun da las reglas ils 22 avust 2026",
...
const routeText: Record<Lang, Record<RouteKey, [string, string, string]>> = {
  ...
  de: {
    ...
    familySwissC: ["Familiennachzug", "Zu Schweizer/in oder C-Inhaber/in", "Zuerst erfolgt der Familiennachzug. Nach der Zulassung bestätigt der Kanton, ob eine separate Arbeitsbewilligung nötig ist."], familyThird: ["Bedingter Familienweg", "Kantonale Prüfung nötig", "Bei B- oder L-Sponsoren zählen Status, Wohnung, Mittel, Beziehung und Kantonsentscheid."], studyJob: ["Studium-/Jobsucheprüfung", "Bestehender Status zählt", "Studierendenarbeit, Schweizer Absolventen und Jobsuchende haben statusbezogene Grenzen."], specialist: ["Spezialprüfung", "Kein sicherer Automatismus", "Der Fall liegt ausserhalb eines verlässlichen Standardwegs. Vor Reise oder Arbeitsbeginn den Kanton fragen."],
  },
  fr: {
    ...
    familySwissC: ["Regroupement familial", "Rejoindre un Suisse ou titulaire C", "Le séjour familial est déposé en premier. Une fois admis, le canton confirme si un permis de travail distinct est nécessaire."], familyThird: ["Voie familiale conditionnelle", "Examen cantonal", "Pour sponsors B ou L, statut, logement, moyens, relation et canton déterminent l’issue."], studyJob: ["Examen études/recherche d’emploi", "Le statut existant compte", "Travail étudiant, diplômés suisses et demandeurs d’emploi suivent des limites propres au statut."], specialist: ["Contrôle spécialisé", "Aucune voie automatique sûre", "Les faits sortent d’un parcours commun fiable. Contactez le canton avant voyage, contrat ou travail."],
  },
  it: {
