...
export const ui = {
  en: {
    ...
    start: "Find my route", employerStart: "I’m hiring someone", time: "Takes about 3 minutes", privacy: "No login · answers are not uploaded",
    routeLabel: "A route, not just a permit letter", routeTitle: "The four decisions that matter",
  ...
  de: {
    ...
    start: "Meinen Weg finden", employerStart: "Ich stelle jemanden ein", time: "Dauert etwa 3 Minuten", privacy: "Kein Login · Antworten werden nicht hochgeladen",
    routeLabel: "Ein ganzer Weg, nicht nur ein Buchstabe", routeTitle: "Die vier entscheidenden Fragen",
  ...
  fr: {
    ...
    start: "Trouver ma voie", employerStart: "Je recrute quelqu’un", time: "Environ 3 minutes", privacy: "Sans compte · réponses non téléversées",
    routeLabel: "Un parcours, pas seulement une lettre", routeTitle: "Les quatre décisions essentielles",
  ...
  it: {
    ...
    start: "Trova il mio percorso", employerStart: "Sto assumendo qualcuno", time: "Circa 3 minuti", privacy: "Senza account · le risposte non vengono caricate",
    routeLabel: "Un percorso, non solo una lettera", routeTitle: "Le quattro decisioni che contano",
  ...
  rm: {
    ...
    start: "Chattar mia via", employerStart: "Jau engaschi insatgi", time: "Circa 3 minutas", privacy: "Nagin login · las respostas na vegnan betg chargiadas",
    routeLabel: "Ina via entira, betg be ina lettera", routeTitle: "Las quatter decisiuns decisivas",
...
const questions: Record<Lang, Record<QuestionKey, [string, string]>> = {
  en: {
    audience: ["Who are you navigating for?", "Each filing step is assigned to the right person."], status: ["Is there already a Swiss status in place?", "Existing permits can change the route completely."],
    ...
    family: ["Will close family members move too?", "A separate family-reunification layer is added when relevant."],
  ...
  de: {
    audience: ["Für wen navigierst du?", "Jeder Schritt wird der richtigen Person zugeordnet."], status: ["Besteht bereits ein Schweizer Status?", "Eine bestehende Bewilligung kann den Weg vollständig ändern."],
    ...
    family: ["Ziehen enge Familienmitglieder mit?", "Bei Bedarf erscheint der separate Familiennachzug."],
  ...
  fr: {
    audience: ["Pour qui faites-vous cette démarche ?", "Chaque dépôt est attribué à la bonne personne."], status: ["Un statut suisse existe-t-il déjà ?", "Un permis existant peut modifier entièrement le parcours."],
    ...
    family: ["Des proches vont-ils aussi déménager ?", "Le regroupement familial apparaît alors comme une couche distincte."],
  ...
  it: {
    audience: ["Per chi stai facendo questa procedura?", "Ogni deposito è assegnato alla persona giusta."], status: ["Esiste già uno statuto svizzero?", "Un permesso esistente può cambiare del tutto il percorso."],
    ...
    family: ["Si trasferiranno anche familiari stretti?", "Il ricongiungimento familiare appare come livello separato."],
  ...
  rm: {
    audience: ["Per tgi navigheschas ti?", "Mintga pass vegn attribuì a la persuna giusta."], status: ["Datti gia in status svizzer?", "Ina permissiun existenta po midar cumplettamain la via."],
    ...
    family: ["Vegnan er commembers da famiglia stretgs?", "La reuniun da famiglia cumpara sco nivel separat."],
