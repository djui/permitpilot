...
export const historyEntries: HistoryEntry[] = [
  {
    ...
    kind: "product",
    title: {
      en: "Dark mode follows your system, unless you choose",
      de: "Dunkler Modus folgt dem System, wenn du nichts anderes wählst",
      fr: "Le mode sombre suit le système, sauf si vous choisissez",
      it: "Il tema scuro segue il sistema, se non scegli altrimenti",
      rm: "Il modus stgir suonda il sistem, sche ti na tschernas betg auter",
    },
    body: {
      en: "The site now has light and dark appearance. Auto is the default and follows your device setting. You can lock Light or Dark in the footer.",
      de: "Die Seite hat jetzt eine helle und eine dunkle Darstellung. Auto ist voreingestellt und folgt dem Gerät. Hell oder Dunkel kannst du in der Fußzeile festlegen.",
      fr: "Le site propose désormais un affichage clair et un affichage sombre. Auto est le réglage par défaut et suit l’appareil. Vous pouvez imposer Clair ou Sombre dans le pied de page.",
      it: "Il sito ha ora un aspetto chiaro e uno scuro. Auto è l’impostazione predefinita e segue il dispositivo. Puoi fissare Chiaro o Scuro nel piè di pagina.",
      rm: "La pagina ha uss in aspect cler ed in stgir. Auto è il standard e suonda tes apparat. Ti pos fixar Cler u Stgir en il pe da pagina.",
    },
  },
  {
    date: "2026-08-22",
    kind: "product",
    title: {
      en: "Easier with keyboard, screen reader, and phone",
      de: "Einfacher mit Tastatur, Screenreader und Handy",
      fr: "Plus simple au clavier, avec un lecteur d’écran et sur téléphone",
      it: "Più semplice da tastiera, con lettore schermo e sul telefono",
      rm: "Pli simpel cun tastatura, lectur da visur e telefonin",
    },
    body: {
      en: "You can skip to the main content, hear language names and when a link opens a new tab, and use How it works, Official sources, Changes and About on a small screen. Focus follows each question and result, and the main buttons meet contrast requirements.",
      de: "Du kannst zum Inhalt springen, Sprachnamen und neue Tabs hören und So funktioniert’s, Offizielle Quellen, Änderungen und Über uns auf dem Handy nutzen. Der Fokus folgt jeder Frage und dem Ergebnis, und die Hauptknöpfe erfüllen die Kontrastvorgaben.",
      fr: "Vous pouvez aller au contenu, entendre les noms de langue et l’ouverture d’un nouvel onglet, et utiliser Fonctionnement, Sources officielles, Changements et À propos sur un petit écran. Le focus suit chaque question et le résultat, et les boutons principaux respectent le contraste.",
      it: "Puoi andare al contenuto, sentire i nomi delle lingue e quando un link apre una nuova scheda, e usare Come funziona, Fonti ufficiali, Modifiche e Chi siamo sul telefono. Il focus segue ogni domanda e il risultato, e i pulsanti principali rispettano il contrasto.",
      rm: "Ti pos siglir tar il cuntegn, udir ils nums da lingua e cura ch’ina colliaziun avra in nov tab, e duvrar Co funcziun’igl, Funtaunas uffizialas, Midadas e Davart nus sin in pitschen visur. Il focus suonda mintga dumonda ed il resultat, e ils buttuns principals adempleschan il contrast.",
    },
  },
  {
    date: "2026-08-22",
    kind: "product",
    title: {
      en: "Legal page, unofficial mark, and safer result links",
      de: "Rechtliche Hinweise, inoffizielles Zeichen und sicherere Ergebnis-Links",
      fr: "Mentions légales, signe non officiel et liens de résultat plus sûrs",
      it: "Note legali, marchio non ufficiale e link del risultato più sicuri",
      rm: "Avis legal, segn betg uffizial e colliaziuns da resultat pli segiras",
    },
    body: {
      en: "There is a Legal page with privacy and liability notices. The site mark is no longer a Swiss cross. Result links follow today’s route for the answers in the link, warn before copying, and do not freeze an old route type. Printouts say unofficial.",
      de: "Es gibt eine Seite Rechtliches mit Hinweisen zu Datenschutz und Haftung. Das Seitenzeichen ist kein Schweizerkreuz mehr. Ergebnis-Links folgen dem heutigen Weg zu den Antworten im Link, warnen vor dem Kopieren und halten keinen alten Wegtyp fest. Ausdrucke kennzeichnen die Seite als inoffiziell.",
      fr: "Une page Mentions décrit confidentialité et responsabilité. Le sigle n’est plus une croix suisse. Les liens de résultat suivent le parcours d’aujourd’hui pour les réponses du lien, avertissent avant la copie et ne figent pas un ancien type de parcours. Les impressions indiquent le caractère non officiel.",
      it: "C’è una pagina Note legali con avvisi su privacy e responsabilità. Il segno del sito non è più una croce svizzera. I link del risultato seguono il percorso di oggi per le risposte nel link, avvisano prima di copiare e non congelano un vecchio tipo di percorso. Le stampe indicano che è non ufficiale.",
      rm: "I dat ina pagina Legal cun avis davart protecziun da datas e responsabladad. Il segn da la pagina n’è betg pli ina crusch svizra. Colliaziuns dal resultat suondan la via dad oz per las respostas en la colliaziun, avertan avant copiar e na congelan nagin tip da via vegl. Stamps di ch’igl è betg uffizial.",
    },
  },
  {
    date: "2026-08-22",
  ...
  },
  {
    ...
    body: {
      en: "You can copy a link to a result and send it to someone else. The link contains the answers; anyone who opens it can see them. Wording, paperwork, official links and the route type follow today’s navigator. There is no account or short address. The existing disclaimer still applies.",
      de: "Du kannst einen Link zum Ergebnis kopieren und weitergeben. Der Link enthält die Antworten; wer ihn öffnet, kann sie sehen. Texte, Unterlagen, offizielle Links und der Wegtyp folgen dem heutigen Navigator. Es gibt kein Konto und keine Kurz-URL. Der bestehende Hinweis gilt weiter.",
      fr: "Vous pouvez copier un lien vers un résultat et l’envoyer. Le lien contient les réponses ; quiconque l’ouvre peut les voir. Les textes, documents, liens officiels et le type de parcours suivent le navigateur d’aujourd’hui. Il n’y a ni compte ni adresse courte. L’avertissement existant s’applique toujours.",
      it: "Puoi copiare un link al risultato e inviarlo. Il link contiene le risposte; chi lo apre può vederle. Testi, documenti, link ufficiali e il tipo di percorso seguono il navigatore di oggi. Non c’è account né indirizzo breve. Resta valido l’avviso già presente.",
      rm: "Ti pos copiar ina colliaziun al resultat e trametter ella. La colliaziun cuntegna las respostas; tgi che l’avra po las vesair. Texts, documents, colliaziuns uffizialas ed il tip da via suondan il navigatur dad oz. I na dat nagin conto e nagina adressa curta. L’avis existant resta valaivel.",
    },
  },
  {
    date: "2026-08-22",
